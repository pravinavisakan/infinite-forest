...
class LSystemPlant extends Shape
{
	...
	//functions for loading obj files asynchronously - adapted from Shape_from_File
	  load_obj_file( filename, transform, shape_transformation )
      {                             // Request the external file and wait for it to load.
        ...
        let file_response = fetch( filename )
          ...
          .then( (obj_file_contents) => {
          	//console.log("oi");
          	this.parse_into_mesh( obj_file_contents, transform, shape_transformation );
          	//console.log("oi2");
          	} )
  ...
  parse_into_mesh( data, transform, shape_transformation )
